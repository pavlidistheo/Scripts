...
var MAXIMUM_UNFOLLOW_ACTIONS_TOTAL = 5900; //Maximum of unfollow actions to perform, in total (among all calls to 'performUnfollow'). Set to 'null' to have no limit.
